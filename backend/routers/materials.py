...
async def upload_material(
    ...
    """
    Upload a material (teacher-only).
    ...
    try:
        ...
        # Only allow teachers or admin
        if user_role not in ("teacher", "admin"):
            raise HTTPException(status_code=403, detail="Only teachers may upload materials")
        ...
        # create signed url if available
        try:
